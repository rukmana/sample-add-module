...
import com.mytmmin.etravel.ViewHolder.Settlement.History.SettlementHistoryListTripApproverViewHolder;

import java.util.ArrayList;

public class SettlementHistoryListTripHistoryApproverAdapter extends RecyclerView.Adapter<SettlementHistoryListTripApproverViewHolder>{
    private ArrayList<MyTravelApprovalsDataModel> mFeedList = new ArrayList<>();
    private Context mContext;
//    private LayoutInflater mLayoutInflater;
    private Activity activity;

    SettlementHistoryListTripHistoryApproverAdapter() {
...
//        notifyDataSetChanged();
    ...
    @Override
    @NonNull
    public SettlementHistoryListTripApproverViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new SettlementHistoryListTripApproverViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SettlementHistoryListTripApproverViewHolder holder, int position) {
