package com.mytmmin.etravel.Filter.Proposal;
...
public class ProposalApproverFilterHelper extends Filter {
    private ArrayList<MyTravelMainDataDataModel> currentList;
    private ProposalApproverListTripApprovalAdapter adapter;
    private Context c;

    public ProposalApproverFilterHelper(ArrayList<MyTravelMainDataDataModel> currentList, ProposalApproverListTripApprovalAdapter adapter, Context c) {
