...
public class ProposalHistoryFilterHelper extends Filter {
    private ArrayList<MyTravelMainDataDataModel> currentList;
    private ProposalHistoryListTripHistoryAdapter adapter;
    private Context c;

    public ProposalHistoryFilterHelper(ArrayList<MyTravelMainDataDataModel> currentList, ProposalHistoryListTripHistoryAdapter adapter, Context c) {
