...
@JvmOverloads constructor(context: Context?, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    var orientations = Orientations.HORIZONTAL
    ...
    init {
        ...
        if (attrs != null) {
            ...
            val orientationOrdinal = typedArray?.getInt(R.styleable.DashedLine_orientations, DottedLine.Orientations.HORIZONTAL.ordinal)
                    ?: DottedLine.Orientations.HORIZONTAL.ordinal
            if (orientationOrdinal == DottedLine.Orientations.VERTICAL.ordinal) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        if (orientations == Orientations.HORIZONTAL) {
