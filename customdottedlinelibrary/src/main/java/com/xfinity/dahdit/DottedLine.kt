...
//    var dotColor: Int
    ...
    init {
        ...
        if (attrs != null) {
            ...
            val orientationOrdinal = typedArray?.getInt(R.styleable.DottedLine_orientations, Orientations.HORIZONTAL.ordinal)
                    ?: Orientations.HORIZONTAL.ordinal
            if (orientationOrdinal == Orientations.VERTICAL.ordinal) {
